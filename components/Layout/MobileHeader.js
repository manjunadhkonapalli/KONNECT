...
function MobileHeader({user: {unreadNotification, email, unreadMessage, username}}) {
    ...
    //This catches the pathname on the link
    const router = useRouter();

    //Its a local func & route is a parameter that we pass 
    const isActive = route => router.pathname === route;    //This will give the highlight of active page
